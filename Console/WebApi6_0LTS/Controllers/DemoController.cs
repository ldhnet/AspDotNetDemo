...
namespace WebApi6_0.Controllers
{
    ...
    public class DemoController : ControllerBase
    {
        ...
        //[HttpPost]
        //[AllowAnonymous]
        //public async Task<IActionResult> SendEmail([FromBody] DemoDto demoDto)
        //{
        //    _logger.LogInformation("1111111");
        //    _logger.LogWarning("2222222222");
        ...
        /// <returns></returns>
        [HttpPost]
        public void UploadSingle(IFormFile file)
        {
            //await Task.Run(() => { });
            //var fileFolder = Path.Combine(Directory.GetCurrentDirectory(), "UploadFiles");
