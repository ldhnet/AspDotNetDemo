...
namespace Framework.Utility
{
    ...
    public static class CheckParameter
    {
        ...
        {
            Required<ArgumentException>(value != null, string.Format("参数“{0}”不能为空引用。", paramName));
        }
        ...
        {
            Required<ArgumentNullException>(!string.IsNullOrEmpty(value), string.Format("参数“{0}”不能为空引用或空字符串。", paramName));
        }
        ...
        {
            Required<ArgumentNullException>(value != Guid.Empty, string.Format("参数“{0}”的值不能为Guid.Empty", paramName));
        }
        ...
        public static void NotNullOrEmpty<T>(IReadOnlyList<T> list, string paramName)
        {
            ...
            Required<ArgumentNullException>(list.Any(), string.Format("参数“{0}”不能为空引用或空集合。", paramName));
        }
        ...
        {
            NotNull(list, paramName);
            Required<ArgumentNullException>(list.All(m => m != null), string.Format("集合“{0}”中不能包含null的项。", paramName));
        }
        ...
        public static void DirectoryExists(string directory, string? paramName = null)
        {
            ...
            Required<DirectoryNotFoundException>(Directory.Exists(directory), string.Format("指定的目录路径“{0}”不存在。", directory));
        }
        ...
        public static void FileExists(string filename, string? paramName = null)
        {
            ...
            Required<FileNotFoundException>(File.Exists(filename), string.Format("指定的文件路径“{0}”不存在。", filename));
        }
    }
}